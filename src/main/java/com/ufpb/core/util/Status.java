...
public enum Status {
    ...
    NON_AUTORIZED(203, "Non-Authoritative Information"), NON_CONTENT(204, "No Content"),
    RESET_CONTENT(205, "Reset Content"), PARTIAL_CONTENT(206, "Partial Content"), 
    MULTIPLE_CONTENT(300, "Multiple Choices"), MOVED_PERMANENTLY(301, "Moved Permanently"), 
    FOUND(302, "Found"), SEE_OTHER(303, "See Other"), NOT_MODIFIED(304, "Not Modified"), 
    ...
    NOT_ACEPTABLE(406, "Not Acceptable"), 
    PROXY_AUTHENTICATION_REQ(407, "Proxy Authentication Required"), 
    ...
    URI_TOO_LONG(414, "Request-URI Too Long"), UNSUPPORTED_MEDIA_TYPE(415, "Unsupported Media Type"), 
    ...
    GATEWAY_TIMEOUT(504, "Gateway Timeout"), HTTP_VERSION_NOT_SUPP(505, "HTTP Version Not Supported");

    private final int valor;
    private final String msg;
    Status(int valor, String msg) {
        this.valor = valor;
        this.msg = msg;
    }
    ...
    public String toString() {
        return String.format("%d %s", valor, msg);
    }
}